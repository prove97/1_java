...
public class InputTest {
	 ...
	 * sc.nextLine()을 추가해 \n 토큰을 비워준다.
	 * 
	 * close() : 더 이상 Scanner을 사용하지 않겠다.
	 * hasNext() : 현재 Scanner 공간에 사용자로부터 입력받은 값이 남아있는지 확인
	 * 				없으면 다른 값이 들어올때까지 무작정 기다렸다가 
	 * 				값이 남아있다면 true를 반환하고, 값이 없다면 false를 반환
	 */
...
//		
////		System.out.println("아직 가져올 값이 있습니까? : " + sc.hasNext());
//
