 ...
 *         
 *     //생성자영역
 *         {데이터를 초기화해주는 특수 목적의 메소드인 생성자를 정의하는 영역}
 *         
 *     //메소드영역
 *         {클래스의 기능을 정의하는 영역}
 *         
 ...
 *  protected : 같은 패키지에서 또는 다른 패키지일 경우 상속구조(부모자식관계) 접근 가능
 *  default(접근제한자를 입력 안했을 때 기본값) : 같은 패키지에서만 접근 가능
...
public class Student { // 학생을 추상화해서 만든 클래스다.
	// 필드 영역
	// 접근제한자(class는 public, default만 올 수 있다) 자료형 변수명;
	/*
	 ...
	 */
	private String name;
	private int age; // 나이는 1년에 한살씩 증가, 나이는 무조건 0보다 크다
	...
	// 접근제한자 클래스명(초기화하고자하는 값을 담은 매개변수들){초기화}
