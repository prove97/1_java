...
public class C_Array_Two {
	 ...
	 *  2차원 배열은 할당된 공간마다 인덱스번호를 두개 부여(앞번호는 몇번째 1차원 배열인지, 뒷번호는 1차원 배열의 몇번째 index인지를 구분)
	 */	 
	public static void main(String[] args) {
		/*
		 * 1. 2차원 배열선언(1차원 배열의 묶음을 참조하는 2차원 배열 참조변수를 만들겠다.)
		 * 자료형 배열명[][];
		 * 자료형[][] 배열명;
		 */
...
//		arr[2][3] = 3;
		...
		// 3행 3열짜리 문자열 배열을 선언 및 할당하고 인덱스 0행 0열부터 2행 2열가지 차례대로 접근하여 (행, 열)값을
		// 저장한 후 출력하세요.
