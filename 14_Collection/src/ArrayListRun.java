...
public class ArrayListRun {
	 ...
	 *  - 프레임워크(Framework) : 이미 만들어져있는 틀(뼈대)
	 *  
	 *  * 배열의 단점과 컬렉션의 장점
	 *  > 배열의 단점
	 ...
	 *   
	 *  > 컬렉션의 장점
	 *      1. 크기 지정을 해줄 필요가 없다. 만일 지정했다고 해도 더 많은 데이터들이 들어오면 알아서 사이즈를 늘려줌. 크기제약이 없다.
	 ...
	 *    방대한 데이터들을 보관, 추가, 삭제 등 이런 과정들이 빈번할 경우 컬렉션을 많이 사용
	 *  
	 */
	public static void main(String[] args) {
		...
		System.out.println(list); // list의 특징 : 순서 유지하면서 담긴다(0번 인덱스부터 차곡차곡)
		
		// 인정된 크기보다 더 많이 넣어도 오류가 발생하지 않는다. => 장점1 : 크기 제약 없다.
		...
		//4. set(int index, E e) : 해당 인덱스 위치에 데이터를 새로 전달된 e로 수정(교체)시켜주는 메소드
		list.set(0, new Music("모래 알갱이","임영웅"));
		System.out.println(list);
		
		//5. size() : List의 크기를 반환시켜주는 메소드(즉, 몇 개의 데이터가 담겨 있는지)
